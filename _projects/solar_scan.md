...
<div class="row justify-content-sm-center">
    <div class="col-sm mt-2 mt-md-0">
        <p><i>Project for:</i></p>
        {% include figure.liquid path="assets/img/company_logos/denbosch.png" title="example image" class="img-fluid rounded z-depth-1" width="200"%}
        <a href="/blog/2019/solarscan/">Blog post</a>
    </div>
    <div class="col-sm mt-10 mt-md-2">
        {% include figure.liquid path="assets/img/solar_scan_thumbnail.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
