...
<div class="row justify-content-sm-center">
    <div class="col-sm mt-2 mt-md-0">
        <p><i>Project for:</i></p>
        {% include figure.liquid path="assets/img/company_logos/fiod.png" title="example image" class="img-fluid rounded z-depth-1" width="200"%}
    </div>
    <div class="col-sm mt-10 mt-md-2">
        {% include figure.liquid path="assets/img/app_detector.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
